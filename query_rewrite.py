...
_ROUTE_EXPANSION = {
    "doctrine":   ["四圣谛", "八正道", "十二因缘", "三法印", "缘起", "中道"],
    "practice":   ["禅修", "念佛", "持咒", "止观", "正念", "修行方法"],
    "scripture":  ["经典", "佛经", "三藏", "般若经", "法华经"],
    "sect":       ["宗派", "禅宗", "净土宗", "天台宗", "大乘", "南传"],
    "concept":    ["空性", "涅槃", "轮回", "因果", "五蕴", "般若"],
    "history":    ["佛教历史", "传播", "玄奘", "鸠摩罗什", "达摩", "慧能"],
    "ritual":     ["礼仪", "法会", "皈依", "上香", "供花", "节日"],
    "basic":      ["佛教", "基础", "入门", "释迦牟尼", "佛陀", "三宝"],
    "life":       ["生活", "日常", "应用", "情绪", "压力", "家庭", "工作", "人际关系",
                   "安忍", "忍辱", "正念", "精进", "自他交换", "佛法与生活"],
}
