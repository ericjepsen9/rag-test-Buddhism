...
QUESTION_ROUTES = {
    ...
    "life": ["生活", "日常", "压力", "减压", "焦虑", "抑郁", "情绪", "心理",
             "工作", "职场", "婚姻", "感情", "恋爱", "家庭", "亲子", "人际关系",
             "吃肉", "素食", "吃素", "饮食", "财富", "赚钱", "金钱", "理财",
             "科学", "矛盾", "冲突", "现代",
             "消极", "避世", "迷信", "误解", "偏见",
             "比较", "区别", "不同", "道教", "基督教", "伊斯兰", "儒家",
             "初学", "入门书", "哪本经", "推荐", "怎么学佛", "开始学佛",
             "供佛", "佛堂", "在家", "居士生活",
             "做梦", "梦见", "感应", "神通", "灵异", "超自然"],
}
...
SECTION_RULES = {
    ...
    "life": {
        "titles": ["十、佛教与现代生活", "佛教与现代生活", "佛教与日常生活",
                    "佛教与生活", "常见误解"],
        "stops": ["十一、"],
    },
}
